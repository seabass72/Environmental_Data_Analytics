...
ggplot(PeterPaul.nutrients.surface, aes(x = sampledate, y = tp_ug, color = lakename)) + 
  geom_point() +
  scale_color_manual(values = c("#7fcdbb", "#253494"))+
  geom_vline(xintercept=as.Date("1993-05-23"), linetype="dashed", col = 'red')
...
3. linear is the best for environmental data 

4. spline if there is mathematics for how the system functions

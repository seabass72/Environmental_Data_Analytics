...
vector1[3] # indexing the third element of vector1 

# Matrices ----
matrix1 <- matrix(1:20, nrow = 5,ncol = 4) # create a data matric with five rows and 4 columns 
matrix1
...
matrix1[4, ] # row 4 indexing
matrix1[ , 3] # column 3 indexing 
matrix1[c(12, 14)] #
matrix1[c(12:14)] #
matrix1[2:4, 1:3] #
...
> ANSWER: The different data types show the data type in the environment tab.

QUESTION: In the R chunk below, write "dataframe1$". Press `tab` after you type the dollar sign. What happens?

> ANSWER: When you press the tab button it selects the first column in the dataframe.

QUESTION: What happens when a comment in R is followed by "----"?

> ANSWER: it creates a section 

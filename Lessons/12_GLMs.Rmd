...
> ANSWER: We found a significant negative correlation relationship between depth and irradiance of water (linear regression; R2 = 0.31, df = 15449, p <0.0001)

will go with final p value if multiple linear regression 
...
irradiancebydepth2 <- 
    ...
    labs(x = "Depth (m)", y = "irridance of water (units)")+

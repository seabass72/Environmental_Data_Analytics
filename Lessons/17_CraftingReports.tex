...
\begin{longtable}[]{@{}ll@{}}
\toprule
Data & Comments\tabularnewline
\midrule
\endhead
EPA Air PM25 \& O3 & ECOTOX of harmful chemicals in
waterways\tabularnewline
ECOTOX Neonicotinoids & EPA air quality data\tabularnewline
NTL LTER Lake Physical and Chemical Data & long term ecological research
concerning physical and chemical characteristics\tabularnewline
USGS Flow Data & usgs flow and discharge data on the eno
river\tabularnewline
\bottomrule
\end{longtable}
...
\NormalTok{ggtheme<-}\StringTok{ }\KeywordTok{theme_classic}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

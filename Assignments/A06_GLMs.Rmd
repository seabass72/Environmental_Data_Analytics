...
> ANSWER: The test that should be run is the Kruskal-Wallis Test due to the fact that the data is not normally distributed.
...
PUB_YEAR_PLOT_pretty <- ggplot(EPA_ECOTOX, aes(  x =Chemical.Name, y= Pub..Year, fill =Chemical.Name))+
  ...
  scale_fill_manual(values = c('#fff5eb','#fee6ce','#fdd0a2','#fdae6b','#fd8d3c','#f16913','#d94801','#a63603','#7f2704'))+theme(legend.position="none")+
...
The model explains 81.46 % of the observed variance of water temperature.

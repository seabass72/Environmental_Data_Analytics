...
# creating function if and else statement 

passed_test_of <- function(Test_score) {
...
passed_test_of(Test_scores) # the function with else and if statement does not work because you are inputting more than one                                  value. You need to put in a for loop to cycle through the test scores.
...
> ANSWER: The ifelse statement created the function that worked whereas the if and else statement function did not work because it required a for loop to cycle through the test score inputs. 
